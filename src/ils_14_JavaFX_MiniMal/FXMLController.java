...
public class FXMLController {
	...
	//hier ist die Methode, die mit der Schaltfläche für einen gefüllten Kreis verbunden ist
	...
	//###################################################### für Einsendeaufgabe 3 #####################################################
	//die Methode zeichnet einen gefüllten Kreis
	//die Breite und Höhe des umgebenden Rechtecks werden als Parameter übergeben
	protected void kreisGefuellt(int breite, int hoehe) {
		//Füllfarbe je nach Farbpicker, anfangs schwarz
		gc.setFill(farbe);
		//ein gefülltes Oval bzw. Kreis erstellen
